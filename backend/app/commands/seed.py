    ...
    listings = [
        {
            ...
            "description": (
                "Clean copy with highlighted chapters, useful for exam revision."
            ),
            "category": "textbooks",
            "kind": "sale",
            "condition": "good",
        ...
        },
        {
            ...
            "description": (
                "Keeps pens, cables, and a calculator tidy on a small study desk."
            ),
            "category": "dorm",
            "kind": "giveaway",
            "condition": "like_new",
        ...
        },
        {
            ...
            "description": (
                "Lightly used racket with a fresh grip. Looking for a board game."
            ),
            "category": "sports",
            "kind": "exchange",
            "condition": "worn",
